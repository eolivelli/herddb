 ...
 * {@code DirectMultipleConcurrentUpdatesSuiteNoIndexesTest} (the file-DSM
 * hammer in {@code herddb-core}). Same workload shape, same 4 variants,
 * routed through the byte-range read path so the value cache is the
 * cache being exercised.
 */
public class LazyValueCacheConcurrentUpdatesSuiteNoIndexesTest
