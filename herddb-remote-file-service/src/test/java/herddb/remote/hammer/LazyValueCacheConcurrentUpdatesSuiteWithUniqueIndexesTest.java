 ...
 * {@code DirectMultipleConcurrentUpdatesSuiteWithUniqueIndexesTest}.
 * Same workload shape (with a UNIQUE secondary index on {@code n1, id}
 * to keep the constraint satisfied as values churn), same 4 variants,
 * routed through the byte-range read path.
 */
public class LazyValueCacheConcurrentUpdatesSuiteWithUniqueIndexesTest
