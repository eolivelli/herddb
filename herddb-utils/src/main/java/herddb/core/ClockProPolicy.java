 ...
 *
 * See
 * http://web.cse.ohio-state.edu/hpcs/WWW/HTML/publications/papers/TR-05-3.pdf
 *
 * @author diego.salvi
 */
public class ClockProPolicy implements PageReplacementPolicy {
 ...
 /*
    ...
    /**
     * Delete given node from both linked list and node space and returns
     * previous node.
     */
...
//            assertSame(handTest, node);
    ...
    /**
     * Insert a non referenced node in the linked list place just before given
     * target node.
     */
...
//        assertNull(inserting.prev);
    ...
    /**
     * Move given node from his place in the linked list to just before given
     * target node.
     */
